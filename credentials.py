"""Desktop credential discovery, refresh and header construction.

Owns the auth-file contract: the per-platform CodeBuddyExtension directory,
the *.info session file, token expiry, refresh over the credential's own
realm, and the header set the upstream backend expects.
"""
...
class CredentialManager:
    """Reads credentials from the auth file; refreshes and writes back before expiry."""
